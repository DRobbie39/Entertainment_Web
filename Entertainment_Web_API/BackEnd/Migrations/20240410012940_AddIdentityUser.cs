    ...
    public partial class AddIdentityUser : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MusicCategoryId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    MusicCategoryName = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MusicCategories", x => x.MusicCategoryId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SingerId = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MusicCategoryId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    AppUserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Musics_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Musics_MusicCategories_MusicCategoryId",
                        column: x => x.MusicCategoryId,
                        principalTable: "MusicCategories",
                        principalColumn: "MusicCategoryId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VideoPostingTime = table.Column<DateOnly>(type: "date", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__MusicOwn__A11E3E7ACF167879", x => new { x.MusicId, x.SingerId });
                    table.ForeignKey(
                        name: "FK__MusicOwne__Music__628FA481",
                        column: x => x.MusicId,
                        principalTable: "Musics",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__MusicOwne__Singe__6383C8BA",
                        column: x => x.SingerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__MusicPla__0AC8567A7A214FA2", x => new { x.MusicId, x.PlaylistId });
                    table.ForeignKey(
                        name: "FK__MusicPlay__Music__6A30C649",
                        column: x => x.MusicId,
                        principalTable: "Musics",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__MusicPlay__Playl__6B24EA82",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Musics_AppUserId",
                table: "Musics",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Musics_MusicCategoryId",
                table: "Musics",
